package com.igoralmeida.agendador_horarios.services;

import com.igoralmeida.agendador_horarios.infrastructure.entity.Agendamento;
import com.igoralmeida.agendador_horarios.infrastructure.repository.AgendamentoRepository;
...
public class AgendamentoService {
    ...
    // Verificar se o horário já está preenchido para o serviço
    ...
    // Metodo para deletar um agendamento com base na data/hora e cliente
    public void deletarAgendamento(LocalDateTime dataHoraAgendamento, String cliente){
        agendamentoRepository.deleteByDataHoraAgendamentoAndCliente(dataHoraAgendamento, cliente);
    }

    // Metodo para buscar os agendamento totais de um dia específico
    ...
    // Metodo para alterar um agendamento existente com base na data/hora e cliente
